...
export default function About() {
  return (
    <div className='py-20 px-4 max-w-4xl mx-auto'>
      ...
      <h1 className='text-3xl font-bold mb-4 text-slate-800'>Bech Do</h1> 
      ...
      <div className=' flex gap-4'>
        <a href="https://x.com/AkshatGirdhar4" ><img src="https://www.99acres.com/universalhp/img/twitter_large.shared.png" alt="" /></a>
        <a href="https://www.instagram.com/livelaw.in/" ><img src="https://www.99acres.com/universalhp/img/fb.shared.png" alt="" /></a>
        <a href="https://www.youtube.com/@akshatgirdhar3865" ><img src="https://www.99acres.com/universalhp/img/footerYoutube.shared.png" alt="" /></a>
      </div>
    </div>
  )
}
